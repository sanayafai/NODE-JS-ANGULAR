...
let CommentController = class CommentController {
    ...
    showCommnetsByIdea(idea, page) {
        return this.commentService.showByIdea(idea, page);
    }
    showCommnetsByUser(user, page) {
...
], CommentController.prototype, "showCommnetsByIdea", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String, Number]),
    __metadata("design:returntype", void 0)
], CommentController.prototype, "showCommnetsByUser", null);
__decorate([

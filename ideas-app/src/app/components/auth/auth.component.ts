...
import {validatorWhiteSpace} from '@app/utilities/validators';
...
export class AuthComponent implements OnInit {
  ...
  ngOnInit() {
    this.authForm = this.fb.group({
      username: this.fb.control('', [Validators.required, validatorWhiteSpace]),
      password: this.fb.control('', [Validators.required, validatorWhiteSpace])
    });
  }
